    ...
    <div class="container">
        ...
        <div class="item">
            ...
            <section class="upload_box">
                ...
                <div class="upload_button_box">
                    ...
                    <el-button class="upload_button select" type="primary">上传图片</el-button>
                </div>
        ...
        <div class="item">
            ...
            <section class="upload_box">
                ...
                <div class="upload_button_box">
                    <!-- <button class="upload_button select">上传图片</button> -->
                    <el-button class="upload_button select" type="primary">选择文件</el-button>
                    <el-button class="upload_button upload" type="success">上传到服务器</el-button>
                </div>
                <div class="upload_tip">只能上传jpg/png格式图片，且大小不能超过2mb</div>
            </section>
        </div>
